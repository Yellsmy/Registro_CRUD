...
const Formulario = ({ opcion, oneData, setOpcion, submitForm }) => {
    const { register, handleSubmit, formState: { errors }, clearErrors, reset, setValue } = useForm(),
        ...
        setData = async () => {
            ...
            setValue('departamento', oneData.departamento)
                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                    <Modal.Body>
                        ...
                        <Form.Group className="mb-3">
                            {/*Texto-título*/}
                            <Form.Label className="fw-bolder"><Icon.Circle size={15} className="text-danger" /> {'Municipio'}</Form.Label>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control
                                ...
                                autoComplete="off"
                            />
                            {errors?.departamento?.type === "required" && <p className="text-danger fw-danger">{"Este campo es requerido"}</p>}
                        </Form.Group>
