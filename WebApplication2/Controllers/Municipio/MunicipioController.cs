...
namespace WebApplication2.Controllers.Municipio
{
    ...
    public class MunicipioController : ControllerBase
    {
        ...
        public IActionResult All()
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("Crud_Municipio", conn))
                {
        ...
        public IActionResult Store(JObject request)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                string departamento = request.GetValue("departamento").ToString();
        ...
        public IActionResult Active(JObject request)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("Crud_Municipio", conn))
                {
                    ...
                    dynamic resultado = new JObject();
                    resultado.response = 1;
                    resultado.message = "El municipio se ha activado con éxito.";
                    resultado.value = 1;
        ...
        public IActionResult GetAllLabel()
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("dbo.Crud_Municipio", conn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
